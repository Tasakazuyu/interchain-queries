...
chains:
  gaia-testnet:
    key: wallet
    chain-id: GAIA
    rpc-addr: http://127.0.0.1:23657      # if you have your own GAIA RPC change it here
    grpc-addr: http://127.0.0.1:23090     # if you have your own GAIA RPC change it here
  ...
  stride-testnet:
    ...
    rpc-addr: http://127.0.0.1:16657      # if you have your own Stride RPC change it here
    grpc-addr: http://127.0.0.1:16090     # if you have your own Stride RPC change it here
...
## 3. Import wallets
> NOTE: use the same wallet you did in relayer task
```
...
You will have to wait some time until you see some logs (5min-2hours):
```
store/bank/key
